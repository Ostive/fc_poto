...
export default function CookiesPage() {
  return (
    <LegalLayout index="03" title="Politique cookies" updated="21 mai 2026">
      ...
      <LegalSection title="Cookies utilisés sur fcpoto.com">
        ...
        <ul className="grid gap-3 list-none">
          <li>
            ...
            fonctionnement du site (préférence cookies, accessibilité). Pas de
            consentement requis.
          </li>
          <li>
            <strong>Mesure d'audience</strong> · Statistiques anonymes (pages
            vues, durée). Outil utilisé : <ToFill /> (à compléter · par
            exemple Plausible, Umami, ou Matomo configuré en mode RGPD).
          </li>
          <li>
      ...
      <LegalSection title="Vos choix">
        ...
        <p>
          Liens utiles pour configurer votre navigateur :
        </p>
        <ul className="grid gap-2 list-disc pl-6">
          <li><a className="link-underline" target="_blank" rel="noreferrer" href="https://support.google.com/chrome/answer/95647">Google Chrome</a></li>
          <li><a className="link-underline" target="_blank" rel="noreferrer" href="https://support.mozilla.org/fr/kb/protection-renforcee-contre-pistage-firefox-ordinateur">Mozilla Firefox</a></li>
          <li><a className="link-underline" target="_blank" rel="noreferrer" href="https://support.apple.com/fr-fr/guide/safari/sfri11471/mac">Safari</a></li>
        </ul>
      </LegalSection>
